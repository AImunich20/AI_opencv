...
# à¸”à¸±à¸Šà¸™à¸µà¸‚à¸­à¸‡à¸ˆà¸¸à¸”à¸”à¸§à¸‡à¸•à¸²à¹à¸¥à¸°à¸£à¸´à¸¡à¸à¸µà¸›à¸²à¸
...
yawn_frames = 0
mar_values = []
window_size = 10  # à¸ªà¸³à¸«à¸£à¸±à¸š Moving Average
MAR_NORMAL = []
MAR_THRESHOLD = 0.8  # à¸„à¹ˆà¸²à¹€à¸£à¸´à¹ˆà¸¡à¸•à¹‰à¸™

def calculate_aspect_ratio(points, indices):
    """à¸„à¸³à¸™à¸§à¸“ Eye Aspect Ratio (EAR)"""
...
def calculate_mouth_aspect_ratio(points):
    """à¸„à¸³à¸™à¸§à¸“ Mouth Aspect Ratio (MAR)"""
...
def adjust_ear_threshold(face_width, face_height, base_threshold):
    """à¸›à¸£à¸±à¸šà¸„à¹ˆà¸² EAR Threshold à¸•à¸²à¸¡à¸‚à¸™à¸²à¸”à¹ƒà¸šà¸«à¸™à¹‰à¸²"""
...
while cap.isOpened():
    ...
    if success:
        frame = cv2.flip(frame, 1)  # à¸à¸¥à¸±à¸šà¸”à¹‰à¸²à¸™à¸ à¸²à¸ž
        ...
        if face_results.multi_face_landmarks:
            for face_landmarks in face_results.multi_face_landmarks:
                ...
                try:
                    ...
                    # à¹ƒà¸Šà¹‰ Moving Average à¸¥à¸” Noise
                    if len(mar_values) >= window_size:
                        mar_values.pop(0)
                    mar_values.append(mar)
                    smoothed_mar = np.mean(mar_values)

                    # à¹€à¸à¹‡à¸šà¸‚à¹‰à¸­à¸¡à¸¹à¸¥ MAR à¸›à¸à¸•à¸´à¹ƒà¸™à¸Šà¹ˆà¸§à¸‡à¹à¸£à¸
                    ...
                    # à¹à¸ªà¸”à¸‡à¸„à¹ˆà¸² EAR à¹à¸¥à¸° MAR à¸—à¸µà¹ˆà¸¡à¸¸à¸¡à¸‹à¹‰à¸²à¸¢à¸šà¸™à¸‚à¸­à¸‡à¸ˆà¸­
                    cv2.putText(
                        annotated_frame,
                        f"EAR: {avg_ear:.2f} MAR: {smoothed_mar:.2f}",
                        (10, 30),  # à¸•à¸³à¹à¸«à¸™à¹ˆà¸‡à¸¡à¸¸à¸¡à¸‹à¹‰à¸²à¸¢à¸šà¸™à¸‚à¸­à¸‡à¸ˆà¸­
                    ...
                    # à¸•à¸£à¸§à¸ˆà¸ˆà¸±à¸šà¸à¸²à¸£à¸«à¸¥à¸±à¸šà¹ƒà¸™
                    if avg_ear < ear_threshold:
                        cv2.putText(
                            annotated_frame,
                            "DROWSINESS DETECTED!",
                            (10, 50),  # à¸•à¸³à¹à¸«à¸™à¹ˆà¸‡à¸¡à¸¸à¸¡à¸‹à¹‰à¸²à¸¢à¸šà¸™à¸‚à¸­à¸‡à¸ˆà¸­
                            cv2.FONT_HERSHEY_SIMPLEX,
                            0.5,
                            (0, 0, 255),
                            2
                    ...
                    if smoothed_mar > MAR_THRESHOLD:
                        ...
                        if yawn_frames > 10:
                            cv2.putText(
                                annotated_frame,
                                "YAWNING DETECTED!",
                                (10, 70),  # à¸•à¸³à¹à¸«à¸™à¹ˆà¸‡à¸¡à¸¸à¸¡à¸‹à¹‰à¸²à¸¢à¸šà¸™à¸‚à¸­à¸‡à¸ˆà¸­
                                cv2.FONT_HERSHEY_SIMPLEX,
                                0.5,
                                (255, 0, 255),
                                2
        ...
        if cv2.waitKey(1) & 0xFF == ord("q"):  # à¸à¸” 'q' à¹€à¸žà¸·à¹ˆà¸­à¸­à¸­à¸à¸ˆà¸²à¸à¹‚à¸›à¸£à¹à¸à¸£à¸¡
            break
    else:
        break
